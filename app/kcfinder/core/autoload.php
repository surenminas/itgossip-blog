...
spl_autoload_register(function ($class) {
    debug(BASE_DIR . "app/kcfinder/core/browser.php");

    if ($class == "uploader")
        require BASE_DIR . "/app/kcfinder/core/uploader.php";
    elseif ($class == "browser")
        require BASE_DIR . "/app/kcfinder/core/browser.php";
    elseif (file_exists(BASE_DIR . "/app/kcfinder/core/types/$class.php"))
        require BASE_DIR . "/app/kcfinder/core/types/$class.php";
    elseif (file_exists(BASE_DIR . "/app/kcfinder/lib/class_$class.php"))
        require BASE_DIR . "/app/kcfinder/lib/class_$class.php";
    elseif (file_exists(BASE_DIR . "/app/kcfinder/lib/helper_$class.php"))
        require BASE_DIR . "/app/kcfinder/lib/helper_$class.php";
